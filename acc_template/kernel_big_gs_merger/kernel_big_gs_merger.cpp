...
void merge_tmp_prop_big_krnls ( 
	// TODO 
				hls::stream<b_tmp_prop_pkt>    			&b_tmp_prop_stm_1,
				hls::stream<b_tmp_prop_pkt>    			&b_tmp_prop_stm_2,
				hls::stream<b_tmp_prop_pkt>    			&b_tmp_prop_stm_3,
...
#pragma HLS pipeline style=flp
		...
		// TODO
		if(!process_flag[0]) process_flag[0] = read_from_stream_nb(b_tmp_prop_stm_1, a_big_krnl_tmp_prop_pkt[0]);
		if(!process_flag[1]) process_flag[1] = read_from_stream_nb(b_tmp_prop_stm_2, a_big_krnl_tmp_prop_pkt[1]);
		if(!process_flag[2]) process_flag[2] = read_from_stream_nb(b_tmp_prop_stm_3, a_big_krnl_tmp_prop_pkt[2]);
